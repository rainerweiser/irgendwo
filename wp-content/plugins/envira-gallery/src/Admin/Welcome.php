...
class Welcome {
	...
	public static function tab_navigation( $tab = 'whats_new' ) {
		...
		<h3 class="nav-tab-wrapper">
			<a class="nav-tab 
			<?php
			if ( 'envira-gallery-welcome' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) :
				?>
			...
			<a class="nav-tab 
			<?php
			if ( 'envira-gallery-get-started' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) :
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
			...
			<a class="nav-tab 
			<?php
			if ( 'envira-gallery-addons' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) :
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
			...
			<a class="nav-tab 
			<?php
			if ( 'envira-gallery-support' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) :
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
			...
			<a class="nav-tab 
			<?php
			if ( 'envira-gallery-changelog' === sanitize_text_field( wp_unslash( $_GET['page'] ) ) ) :
				?>
				nav-tab-active<?php endif; ?>" href="
				<?php
				echo esc_url(
	...
	public static function is_new_install() {
		...
		if ( isset( $_GET['is_new_install'] ) && 'true' === strtolower( santitize_text_field( wp_unslash( $_GET['is_new_install'] ) ) ) ) {
			return true;
