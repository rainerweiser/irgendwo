...
define( 'WPCACHEHOME', '/homepages/12/d20886013/htdocs/irgendwo/wp-content/plugins/wp-super-cache/' );
define('DB_NAME', 'db475942568');

/** Ersetze username_here mit deinem MySQL-Datenbank-Benutzernamen */
define('DB_USER', 'dbo475942568');

/** Ersetze password_here mit deinem MySQL-Passwort */
define('DB_PASSWORD', 'dbadmin');

/** Ersetze localhost mit der MySQL-Serveradresse */
define('DB_HOST', 'db475942568.db.1and1.com');
